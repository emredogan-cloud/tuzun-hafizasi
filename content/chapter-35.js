/* ════════════════════════════════════════════════════════════════
   chapter-35.js — Bölüm XXXV · Lemi'nin Sonu
   Akt: Anılma. POV: Reha (Nahide için bir paragraflık serbest dolaylı
   geçiş). Sabah erken Nahide gelir. Lemi yatağında, sakin. Pencerede
   balmumu kase, tuz oluşmuş. Yıkama, kefenleme. Behçet Amca. Sade
   cenaze. Reha Nahide'yi eve götürür. \"Senin odan olacak.\" Akşam
   Nahide uyuduktan sonra Reha yalnız oturur.
   ════════════════════════════════════════════════════════════════ */
...
window.TUZ.entries.push({
    id: "bolum-35",
    title: "Lemi'nin Sonu",
    subtitle: "Bir yatak; bir kase; bir oda; bir başka oda",
    category: "anilma",
    ...
    content: [
        ...
        "Üç vuruş arka arkaya — askeri ritmin değildi (İlhan'ın ritmi değildi), Levent Amca'nın ritmi değildi (yavaş bir-iki). Bu hızlıydı, küçüktü, soluk soluğa.",

        "Reha hırkasını omuzlarına attı. Aşağıya indi. Kapıyı açtı.",

        "Nahide kapıdaydı.",

        "Hırkası yarım giyili — bir kolu içeride, bir kolu dışarıda. Saçı toplanmamıştı tam, bir parça yana eğik. Yüzünde bir gerginlik değildi tam, bir başka şey: bir kabul, bir kuruluk. Soluğu kısa.",
        ...
        "Üç kelime. Bedeni bekliyordu bu cümleyi son hafta boyunca — şimdi gelmişti.",

        "— Geliyorum.",

        "Hırkasını tam çekti. Çizmelerini ayağına geçirdi mutfak masasının altından. Bir dakikadan az.",

        "Nahide kapı eşiğinde bekledi. Bir adımını içeri atmamıştı tam.",
        ...
        "Yatak odanın bir köşesindeydi, ayakucunda küçük bir sehpa, üstünde bir tas ve bir mendil (gece içinden için belki, ya da öksürürken kullanmak için). Lemi yatağında sırtüstü yatmıştı — gözleri kapalı, ağzı yarım açık değildi tam, dudakları yumuşak kapanmış. Yorgan çenesine kadar çekilmişti — Nahide muhtemelen onu öyle ayarlamıştı uyumadan önce, ya da Lemi kendi son hareketi olarak.",

        "Reha yatağa yaklaştı. Bir adım, iki adım. Yatağın yan tarafında durdu.",
        ...
        "Reha bir-iki saniye baktı. Sonra döndü Nahide'ye.",

        "— Ne zaman?",

        "Nahide cevap verdi sakince.",

        "— Gece yarısı civarı belki. Ben uyumuştum kendi yatağımda, perde arkasında. Sabah saat beş buçukta kalktım — ses yoktu bu odada hiç, ne öksürük ne nefes. Geldim baktım. Soğuktu eli. Bir-iki dakika oturdum yatağında. Sonra koştum sana.",
        ...
        "Reha kaseye dokunmadı. Pencerede bıraktı yine.",

        "Geri yatağa döndü.",

        { style: "hr" },

        "Nahide bir küçük çantayı eline aldı — perde arkasındaki dolapta, hep orada dururdu. Bir Tuzcu çırağının cenaze çantası — Reha onu daha önce görmemişti tam, ama varlığını biliyordu. Lemi yıllar önce ona göstermişti belki — bir kez Bölüm on altıda çay içerken, bir kez başka.",

        "İçinde küçük şeyler: bir küçük şişe gül suyu, iki ince keten parça (yıkama için), bir daha büyük keten parça (kefenleme için), bir kese yumuşak sabun, bir küçük tarak, bir-iki damla esans (sadece adı için, kullanılmaz tam — bedene sürülmez, yanına konur).",

        "Nahide bir kürek de getirmişti — bir Tuzcu cenazesinde kürek değil, bir küçük tahta kepçe; tas içindeki suyu kasenin etrafına dökmek için belki, ya da bir başka iş için. Reha bilmiyordu bu detayı.",

        "Nahide çantayı yatağın yanındaki sehpada açtı.",

        "— Yardım edersin sen, dedi. Bedeni döndürmek için iki kişi gerek. Bunu daha önce yapmadın belki — söyleyeyim sana adım adım. Lemi öğretti bana üç yıl önce. Bir kez daha söyleyişle anlarsın.",
        ...
        "Sol bilek. Sonra dirsek. Sonra omuz.",

        "Yumuşaktı, yıkadı, suyu sildi.",

        { style: "hr" },

        "(Nahide bunu üç yıl önce öğrendi. Lemi'nin yardımı olmadan bir kez bile yapmamıştı tam — Tuzhane'de yaşlı bir kadın için bir kez yardımcı olmuştu, ama yıkamayı Lemi yapmıştı. Şimdi Lemi'yi kendisi yıkıyordu. Bu garip bir geri-dönüş gibi geldi bedenine — öğretmen öğrencisini bir gün öğretirken, öğrencinin bir gün öğretmeni yıkayacağını bilirdi belki. Lemi bunu biliyor muydu, bilmiyor muydu — Nahide şu an bunu sormuyordu. Eli işliyordu. Yıkamak bir iş — Lemi söylemişti bunu yıllar önce defalarca. \"İş bedenle olur. Düşünmek başka bir kapı.\" Şimdi Nahide işi yapıyordu, düşünme başka bir kapıdaydı. Bedeni yıkamayı biliyordu — el parmak ardı parmak. Lemi'nin teni yumuşaktı yine — son haftada incelmişti, ama tatçı eli hâlâ tatçı eliydi. Nahide bir an boyunca bir cümle istedi söylemek — bedeni vermedi cümleyi. Tamam, dedi içinden, bedenle. Tamam.)",
        ...
        "Yalnız bir kelime — bir vedalaşma, bir kabul. Behçet Lemi'yi yıllarca biliyordu — Defter-Hâne kayıtçısı olarak Tuzcu Lemi'yi bilirdi, ama bir tür bir başka adam olarak. Şimdi son kez bedenini gördü.",

        "— Mezar var hazır, dedi Behçet. Levent Amca dün öğleden sonra kazmıştı — Lemi söylemişti bir-iki hafta önce, kendisi yer ayırdı. Cenaze öğleden sonra yapacağız belki — saat ikide. Olur mu?",
        ...
        "Cenaze öğleden sonra saat ikide yapıldı.",
        ...
        "— Nahide. Sana bir oda göstereceğim.",

        "Nahide başını eğdi.",

        "Reha onu üst kata çıkardı.",

        "Mâra'nın eski odası yatağı bir hafta önce çıplaktı — çarşaflar yıkanmıştı, dolaba kaldırılmıştı. Reha sabah bu sabah Nahide gelmeden önce düşünmemişti orayı hazırlamayı. Şimdi yapacaktı — ama yarın belki, ya da bir-iki gün içinde. Şimdilik:",

        "— Bu oda annemindi. Yatak hazır değil tam henüz — bir-iki gün içinde çarşaflar koyarız beraber. Şu an yan tarafta küçük bir oda var — eskiden Cilâl Hala buraya gelirken o orada uyurdu. Sen orada şimdilik. Sonra bu oda senin olur, eğer istersen. Ya da küçük oda senin olur. Sen kararını verirsin.",
        ...
        "Reha bir cümle söylemek istedi — bir hoş geldin değildi tam, bir başka şey. Söyledi:",
        ...
        "Akşam yemeği sade. Reha bir tabak çorba ısıttı sobada — Lemi'nin Bölüm otuzunda gönderdiği çorbanın geri kalanı değildi tam, bir başka çorba; Nahide sabah bir tas getirmişti çantasında. İkisi karşılıklı mutfak masasında.",
